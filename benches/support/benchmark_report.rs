...
const CRATE_TITLE: &str = "Hypersolve";
const SKIP_ENV: &str = "HYPERSOLVE_SKIP_BENCHMARK_REPORTS";
...
fn render_section(rows: &[Row], suites: &[BenchSuite]) -> (String, usize) {
    ...
    out.push_str("| `cgal_quadratic` | external exact comparison | `CGAL, GMP` | `benches/competitors/run_cgal_quadratic.sh` | [cgal_quadratic_benchmarks.md](cgal_quadratic_benchmarks.md) |\n");
